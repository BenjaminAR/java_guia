...
*Objeto :* un objeto es la unidad básica de la POO. si la clase es el molde para hacer el pan, el objeto seria el pan. En práctica un objeto es la instancia de una clase.
